...
return [
    'configs' => [
        [
             ...
             */
            'signing_secret' => env('LINE_BOT_CHANNEL_SECRET'),
             ...
             */
            'signature_validator' => \App\Webhook\WebhookSignatureValidator::class,
             ...
             */
            'webhook_response' => \App\Webhook\WebhookResponse::class,
             ...
             */
            'process_webhook_job' => \App\Webhook\WebhookJob::class,
        ],
    ],
];
